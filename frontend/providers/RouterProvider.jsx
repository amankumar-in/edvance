...
import { ErrorBoundaryWrapper, ProtectedLayout } from '../src/components';
...
import ProtectedRoute, { RoleBasedRedirect } from "../src/pages/ProtectedRoute";
import { ClassAttendance, ClassDetails, ClassOverview, ClassStudents, CreateSchoolReward, EditSchoolProfile, JoinRequests, SchoolAdminDashboard, SchoolAdminDashboardLayout, Administrators as SchoolAdministrators, Classes as SchoolClasses, CreateTask as SchoolCreateTask, SchoolProfile, SchoolRewardRedemption, SchoolRewards, Students as SchoolStudents, SchoolTasks, Teachers as SchoolTeachers, TaskClaims } from "../src/pages/school-admin";
