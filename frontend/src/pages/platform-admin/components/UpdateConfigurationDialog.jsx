import { Box, Button, Callout, Dialog, Flex, Heading, Switch, Tabs, Text, TextField } from '@radix-ui/themes';
        ...
        <Dialog.Content style={{ maxWidth: '700px' }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
            <Tabs.Root value={activeTab} onValueChange={setActiveTab}>
              ...
              <Box className="overflow-y-auto mt-4 h-[45vh] p-4">
                ...
                <Tabs.Content value="limits" className="space-y-4">
                  <Box>
            ...
            <Flex gap="3" justify="end" className="pt-4 mt-6 border-t border-[--gray-a6]">
              <Dialog.Close>
                <Button
                  variant="soft"
                  color="gray"
