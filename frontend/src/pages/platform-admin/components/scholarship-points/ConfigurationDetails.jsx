import { Box, Button, Card, Dialog, Flex, Heading, Separator, Text } from '@radix-ui/themes';
...
const ConfigurationVersionDetails = ({ version, open, onOpenChange, children = null }) => {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Content style={{ maxWidth: '800px' }} className='space-y-4'>
        {children && (
        ...
        {isLoading ? (
          ...
          <Box className="overflow-y-auto space-y-4 max-h-[60vh] p-2">
